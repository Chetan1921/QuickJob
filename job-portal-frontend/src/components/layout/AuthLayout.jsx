...
export default function AuthLayout({ title, subtitle, children, footer }) {
  return (
    <div className="relative min-h-screen w-full bg-[#0a0a14] flex items-center justify-center px-4 py-12 overflow-hidden">
      ...
      <div className="relative w-full max-w-[440px]">
        ...
        <div className="relative">
          ...
          <div className="relative bg-white/[0.06] backdrop-blur-2xl border border-white/10 rounded-[26px] shadow-2xl shadow-black/50 p-7 sm:p-9">
            <div className="text-center mb-7">
              <h1 className="text-[26px] font-bold text-white mb-1.5 tracking-tight">{title}</h1>
              {subtitle && <p className="text-gray-400 text-[15px]">{subtitle}</p>}
            </div>
            {children}
          </div>
        </div>
