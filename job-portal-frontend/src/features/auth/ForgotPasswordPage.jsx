...
export default function ForgotPasswordPage() {
  ...
  return (
    <AuthLayout
      ...
      footer={
        <Link to="/login" className="text-sm text-gray-400 hover:text-white inline-flex items-center gap-1.5 transition-colors">
    ...
    >
      {sent ? (
        <div className="flex flex-col items-center text-center py-4">
          ...
          <p className="text-white font-medium mb-1.5">Check your inbox</p>
          <p className="text-gray-400 text-sm">
            We sent a reset link to <span className="text-gray-300">{getValues('email')}</span>
          </p>
        </div>
      ) : (
