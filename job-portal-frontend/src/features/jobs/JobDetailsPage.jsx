    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-10">
      ...
      <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-6 sm:p-8 mb-6">
        <div className="flex flex-col sm:flex-row sm:items-center gap-4 mb-6">
          <div className="h-16 w-16 rounded-2xl bg-white/5 border border-white/10 overflow-hidden flex items-center justify-center shrink-0">
            {job.company_logo ? (
      ...
      {job.company_description && (
        <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-6 sm:p-8">
          <h3 className="text-white font-semibold mb-2">About {job.company_name}</h3>
          <p className="text-gray-400 text-sm leading-relaxed">{job.company_description}</p>
          {job.company_website && (
