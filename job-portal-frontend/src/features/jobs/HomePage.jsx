    ...
    <div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 pt-20 pb-16 text-center">
          <span className="inline-block text-xs font-medium text-indigo-300 bg-primary/10 border border-primary/20 rounded-full px-3 py-1 mb-6">
          ...
          <form
            ...
            className="max-w-xl mx-auto flex items-center gap-2 bg-white/[0.05] border border-white/10 rounded-2xl p-2 backdrop-blur-xl"
          >
            ...
            <button
              type="submit"
              className="text-sm font-semibold text-white bg-gradient-to-r from-primary to-primary-dark px-5 py-2.5 rounded-xl shadow-lg shadow-primary/25 hover:brightness-110 transition-all whitespace-nowrap"
            >
              Search
            </button>
          </form>
