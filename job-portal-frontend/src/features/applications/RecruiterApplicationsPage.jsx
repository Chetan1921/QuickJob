...
export default function RecruiterApplicationsPage() {
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold text-white mb-1.5">Applications</h1>
      ...
      {!jobId ? (
        ...
        <div className="space-y-3">
          {applications.map((app) => (
            <div key={app.application_id} className="flex items-center justify-between gap-4 rounded-xl border border-white/10 bg-white/[0.03] px-5 py-4">
              <div className="flex items-center gap-3 min-w-0">
                ...
                <div className="min-w-0">
                  <p className="text-white font-medium truncate">Applicant #{app.applicant_id}</p>
              ...
              <div className="flex items-center gap-3 shrink-0">
                ...
                <select
                  ...
                  className="text-xs bg-black/20 border border-white/10 text-gray-300 rounded-lg px-2.5 py-1.5 focus:outline-none focus:border-primary/50"
                >
