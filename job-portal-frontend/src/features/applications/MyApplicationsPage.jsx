...
export default function MyApplicationsPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-10">
      <h1 className="text-2xl font-bold text-white mb-1.5">My Applications</h1>
      <p className="text-gray-400 text-sm mb-8">Track the status of every job you've applied to</p>
      ...
      {loading ? (
        ...
        <EmptyState
          ...
          action={
            <Link to="/jobs" className="text-sm font-semibold text-white bg-primary px-5 py-2.5 rounded-lg hover:bg-primary-dark transition-all">
              Browse Jobs
            </Link>
          }
        />
        ...
        <div className="space-y-3">
          {applications.map((app) => (
            <Link
              ...
              to={`/jobs/${app.job_id}`}
              className="flex items-center gap-4 rounded-xl border border-white/10 bg-white/[0.03] hover:bg-white/[0.05] px-5 py-4 transition-all"
            >
